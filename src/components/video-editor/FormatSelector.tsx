				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#D4D0C8]/50 focus:ring-offset-2 focus:ring-offset-editor-dialog",
							isSelected
								? "bg-[#D4D0C8]/10 border-[#D4D0C8]/50 text-[#D4D0C8] dark:text-white"
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#D4D0C8]/20 text-[#D4D0C8]" : "bg-foreground/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#D4D0C8]" />
						)}
					</button>
				);
			})}
