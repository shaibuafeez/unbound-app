			...
			<DialogContent className="bg-editor-dialog border-foreground/10 text-foreground max-w-[460px]">
				<DialogHeader>
					<DialogTitle className="flex items-center gap-2 text-sm">
						<Keyboard className="w-4 h-4 text-[#D4D0C8]" />
								...
								<div className="flex items-center justify-between py-1.5 px-1 border-b border-foreground/5">
									...
									<button
										...
										className={[
											...
											isCapturing
												? "bg-[#D4D0C8]/20 border-[#D4D0C8] text-[#D4D0C8] animate-pulse"
												: hasConflict
													? "bg-amber-500/10 border-amber-500/50 text-amber-400"
													: "bg-foreground/5 border-foreground/10 text-foreground hover:border-[#D4D0C8]/50 hover:text-[#D4D0C8] cursor-pointer",
										].join(" ")}
									>
										{isCapturing
				...
				<DialogFooter className="flex gap-2 sm:justify-between mt-2">
					...
					<div className="flex gap-2">
						...
						<Button
							size="sm"
							className="bg-[#D4D0C8] hover:bg-[#1d4ed8] text-white"
							onClick={handleSave}
						>
