...
```bash
security export -k ~/Library/Keychains/login.keychain-db -t identities -f pkcs12 -P "YOUR_P12_PASSWORD" -o unbound-mac-signing.p12
base64 < unbound-mac-signing.p12 | pbcopy
```
